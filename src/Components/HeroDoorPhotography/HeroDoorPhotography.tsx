...
// Assets
import heroMainImg from '../../assets/img/photography/hero_main.png';
import lensAct1Img from '../../assets/img/photography/lens_act1.png';
import lensAct3Img from '../../assets/img/photography/lens_act3.png';

import './HeroDoorPhotography.scss';

interface HeroDoorPhotographyProps {
    onUnlock?: () => void;
}

const HeroDoorPhotography: React.FC<HeroDoorPhotographyProps> = ({ onUnlock }) => {
    ...
    useGSAP(() => {
        ...
        const unlock = () => {
            ...
            tl.to('.central-door', { scale: 0.9, opacity: 0, duration: 0.8, ease: "power4.in" })
              ...
              .to('.hero-door-photography', { pointerEvents: 'none', visibility: 'hidden', duration: 0.5 });
        };
    ...
    return (
        <section className="hero-door-photography" ref={containerRef}>
...
export default HeroDoorPhotography;
