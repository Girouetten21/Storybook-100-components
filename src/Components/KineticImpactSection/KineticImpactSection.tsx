...
import foundationImg from '../../assets/img/impact_foundation.png';
import velocityImg from '../../assets/img/impact_velocity.png';
import precisionImg from '../../assets/img/impact_precision.png';
