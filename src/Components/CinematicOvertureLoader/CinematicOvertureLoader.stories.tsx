...
import { CinematicOvertureLoader } from './CinematicOvertureLoader';

const meta = {
  title: 'Loaders/CinematicOvertureLoader',
  component: CinematicOvertureLoader,
  parameters: {
    layout: 'fullscreen',
  },
} satisfies Meta<typeof CinematicOvertureLoader>;
