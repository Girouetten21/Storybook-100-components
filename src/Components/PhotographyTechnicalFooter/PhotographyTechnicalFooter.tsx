                ...
                <div className="footer-links-grid">
                    ...
                    <div className="footer-column">
                        ...
                        <div className="studio-info">
                            <p>North Optics District, Studio 104</p>
                            <p>T: +44 020 7946 0000</p>
                            <a href="mailto:studio@optical-narrative.co" className="studio-email">studio@optical-narrative.co</a>
                        </div>
                    </div>
                </div>
