...
import { MagazineAccordionMenu } from './MagazineAccordionMenu';

const meta = {
  title: 'Navigation/MagazineAccordionMenu',
  component: MagazineAccordionMenu,
  parameters: {
    layout: 'fullscreen',
    viewport: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof MagazineAccordionMenu>;
