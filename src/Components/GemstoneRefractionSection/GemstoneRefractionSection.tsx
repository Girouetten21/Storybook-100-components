...
import './GemstoneRefractionSection.scss';

// Curated Gem Assets
import emeraldImg from '../../assets/img/gems/emerald.png';
import sapphireImg from '../../assets/img/gems/sapphire.png';
...
export const GemstoneRefractionSection: React.FC = () => {
...
export default GemstoneRefractionSection;
