...
import './GemInfinityScroll.scss';

// High-end abstract backgrounds (using existing project assets)
import bg1 from '../../img/generated_1.png';
import bg2 from '../../img/generated_2.png';
import bg3 from '../../img/generated_3.png';
import bg4 from '../../img/generated_4.png';
...
export const GemInfinityScroll: React.FC = () => {
...
export default GemInfinityScroll;
