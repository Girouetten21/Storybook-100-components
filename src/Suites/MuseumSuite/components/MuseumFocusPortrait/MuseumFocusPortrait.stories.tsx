...
import { MuseumFocusPortrait } from './MuseumFocusPortrait';
import bgPhoto from './Photos/background.webp';

const meta = {
  title: 'Components/MuseumFocusPortrait',
  component: MuseumFocusPortrait,
  parameters: {
    layout: 'fullscreen',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof MuseumFocusPortrait>;
