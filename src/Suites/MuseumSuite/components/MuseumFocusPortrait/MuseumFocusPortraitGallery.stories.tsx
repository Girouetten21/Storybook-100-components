...
import { MuseumFocusPortraitGallery } from './MuseumFocusPortraitGallery';
...
const meta = {
  title: 'Components/MuseumFocusPortraitGallery',
  component: MuseumFocusPortraitGallery,
  parameters: {
    layout: 'fullscreen',
  },
  tags: ['autodocs'],
  ...
  decorators: [
    (Story) => (
      <main
        className="museum-focus-portrait-showcase"
...
} satisfies Meta<typeof MuseumFocusPortraitGallery>;
