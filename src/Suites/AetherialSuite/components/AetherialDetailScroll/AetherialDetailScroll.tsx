...
import './AetherialDetailScroll.scss';

// Import fashion imagery
import atelierMain from '../../img/generated_2.png';
...
export const AetherialDetailScroll: React.FC = () => {
    ...
    useGSAP(() => {
        ...
        // Outro delay buffer before unpinning
...
export default AetherialDetailScroll;
