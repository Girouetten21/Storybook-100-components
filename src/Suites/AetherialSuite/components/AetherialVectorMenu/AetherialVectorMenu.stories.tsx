...
import { AetherialVectorMenu } from './AetherialVectorMenu';

const meta = {
  title: 'Navigation/AetherialVectorMenu',
  component: AetherialVectorMenu,
  parameters: {
    layout: 'fullscreen',
    viewport: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof AetherialVectorMenu>;
