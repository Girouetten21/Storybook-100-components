...
import './AetherialMonolithHero.scss';

// High-end background
import bgElite from '../../img/generated_1.png';

gsap.registerPlugin(useGSAP);

const preventScroll = (e: Event) => e.preventDefault();

export const AetherialMonolithHero: React.FC = () => {
    ...
    const runThresholdTransition = contextSafe(() => {
        ...
        const tl = gsap.timeline({
            onComplete: () => {
                setIsRevealed(true);
                // CRITICAL: Refresh ScrollTrigger because the layout changed from fixed to relative
                // ensures Detail and Journey find their new 'top top' positions
                setTimeout(() => {
        ...
        <div ref={containerRef} className={`aether-threshold-container ${isRevealed ? 'is-stable' : ''}`}>
            ...
            <div className={`aether-final-reveal ${isRevealed ? 'is-visible' : ''}`}>
                ...
                <div className="aether-reveal-content">
                    ...
                    <h2><span>Aetherial</span><span className="dot">.</span></h2>
...
export default AetherialMonolithHero;
