...
import { IrisFeatureGallery } from './IrisFeatureGallery';

const meta = {
    title: 'Components/IrisFeatureGallery',
    component: IrisFeatureGallery,
    parameters: {
        layout: 'fullscreen',
    },
    tags: ['autodocs'],
} satisfies Meta<typeof IrisFeatureGallery>;
