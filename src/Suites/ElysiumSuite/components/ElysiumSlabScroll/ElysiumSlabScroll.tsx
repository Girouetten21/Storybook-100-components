...
import './ElysiumSlabScroll.scss';

// Material Textures
import marbleImg from '../../img/generated_7.png';
import woodImg from '../../img/generated_8.png';
import stoneImg from '../../img/generated_9.png';
...
export const ElysiumSlabScroll: React.FC = () => {
    ...
    return (
        <div className="elysium-slab-scroll" ref={containerRef}>
            {SLABS.map((slab) => (
...
export default ElysiumSlabScroll;
