...
import { KineticKineticKineticVelocityGallery } from './KineticKineticKineticVelocityGallery';

const meta = {
    title: 'Components/KineticKineticKineticVelocityGallery',
    component: KineticKineticKineticVelocityGallery,
    parameters: {
        layout: 'fullscreen',
    },
    tags: ['autodocs'],
} satisfies Meta<typeof KineticKineticKineticVelocityGallery>;
...
export const WithScrollTesting: Story = {
    render: () => (
        <div style={{ margin: 0, padding: 0 }}>
            ...
            <KineticKineticKineticVelocityGallery />
